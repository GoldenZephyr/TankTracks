...
IMG_WIDTH_SPOTTER = 640#640
IMG_HEIGHT_SPOTTER = 480#480  # configured for the e-con systems camera
COLOR_CHAN_SPOTTER = 3
IMG_DISP_WIDTH_SPOTTER = 960 #int(IMG_WIDTH_SPOTTER)
IMG_DISP_HEIGHT_SPOTTER = 720 #int(IMG_HEIGHT_SPOTTER)

IMG_TRACK_WIDTH_SPOTTER = IMG_WIDTH_SPOTTER
IMG_TRACK_HEIGHT_SPOTTER = IMG_HEIGHT_SPOTTER
